...
const phaseDescriptions = {
  ...
  // ---------- Guardar badge en Edge Function ----------
  ...
  async function saveLabel() {
    ...
    try {
      ...
      if (res.ok) console.log('Badge saved ✅', result);
      else console.error('Error saving badge', result);
    } catch (e) {
      console.error('Network error saving badge:', e);
    }
  }
